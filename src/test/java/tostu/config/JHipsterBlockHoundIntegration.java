...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("tostu.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("tostu.security.DomainUserDetailsService", "createSpringSecurityUser");
